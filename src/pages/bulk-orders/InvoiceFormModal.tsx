...
import type { BulkQuotation, InvoiceInput, BulkCustomer } from '@/types'
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create an invoice from quotation {quotation?.quotationNumber}. You can adjust
            items before generating the final invoice.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              <Label>Items (You can adjust before generating)</Label>
                ...
                <table className="w-full">
                  <thead className="bg-muted/50">
                    <tr>
                      ...
                      <th className="text-right p-3 text-sm font-medium w-20">Disc %</th>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm text-amber-800">
              <strong>Note:</strong> Once the invoice is generated, it cannot be modified.
